...
import { generateMcm } from "@/lib/search/mcmLogic";
import { mcmSnippets } from "@/lib/search/mcmCode";
...
export default function Page() {
  ...
  const handleRun = () => {
      runAnimation((generateMcm as any)([1, 2, 3, 4]));
  };
  ...
  return (
    <main className="flex min-h-screen flex-col items-center bg-slate-950 text-white p-4 md:p-8 relative font-sans">
      ...
      <h1 className="text-3xl font-extrabold mb-2 bg-linear-to-r from-blue-400 to-indigo-500 bg-clip-text text-transparent">Matrix Chain Multiplication</h1>
