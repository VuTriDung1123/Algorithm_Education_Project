...
import { generateLis } from "@/lib/search/lisLogic";
import { lisSnippets } from "@/lib/search/lisCode";
...
export default function Page() {
  ...
  const handleRun = () => {
      runAnimation((generateLis as any)([10, 9, 2, 5, 3, 7, 101, 18]));
  };
  ...
  return (
    <main className="flex min-h-screen flex-col items-center bg-slate-950 text-white p-4 md:p-8 relative font-sans">
      ...
      <h1 className="text-3xl font-extrabold mb-2 bg-linear-to-r from-blue-400 to-indigo-500 bg-clip-text text-transparent">Longest Increasing Subsequence</h1>
