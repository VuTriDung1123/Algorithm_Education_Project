...
import { generateLcs } from "@/lib/search/lcsLogic";
import { lcsSnippets } from "@/lib/search/lcsCode";
...
export default function Page() {
  ...
  const handleRun = () => {
      runAnimation((generateLcs as any)("AGGTAB", "GXTXAYB"));
  };
  ...
  return (
    <main className="flex min-h-screen flex-col items-center bg-slate-950 text-white p-4 md:p-8 relative font-sans">
      ...
      <h1 className="text-3xl font-extrabold mb-2 bg-linear-to-r from-blue-400 to-indigo-500 bg-clip-text text-transparent">Longest Common Subsequence</h1>
