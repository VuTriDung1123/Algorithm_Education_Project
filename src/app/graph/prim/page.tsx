...
import { createPrimGraph, generatePrim } from "@/lib/search/primLogic";
import { primSnippets } from "@/lib/search/primCode";

export default function Page() {
  const [graphData, setGraphData] = useState<GraphStateData>(() => createPrimGraph());
  ...
  return (
    <main className="flex min-h-screen flex-col items-center bg-slate-950 text-white p-4 md:p-8 relative font-sans">
      ...
      <h1 className="text-3xl font-extrabold mb-2 bg-linear-to-r from-pink-400 to-purple-500 bg-clip-text text-transparent">Prim Algorithm</h1>
