...
import { linearSearchLogic } from "@/lib/search/linearSearchLogic";
import { linearSearchSnippets } from "@/lib/search/linearSearchCode";
...
export default function LinearSearchPage() {
    ...
    const startSearch = () => {
        if (isPlaying) return;
        generatorRef.current = linearSearchLogic(array, target);
        setIsPlaying(true);
        executeNextStep();
    };
        ...
        <main className="flex min-h-screen flex-col items-center bg-slate-950 text-white p-4 font-sans">
            ...
            <div className="w-full max-w-7xl mt-12 bg-slate-900 border border-slate-800 rounded-xl overflow-hidden">
                ...
                <div className="p-4 font-mono text-sm overflow-x-auto">
                    {linearSearchSnippets.javascript.split('\n').map((line: string, i: number) => (
