...
import { jumpSearchLogic } from "@/lib/search/jumpSearchLogic";
import { jumpSearchSnippets } from "@/lib/search/jumpSearchCode";
...
export default function JumpSearchPage() {
    ...
    const startSearch = () => {
        if (isPlaying) return;
        generatorRef.current = jumpSearchLogic(array, target);
        setIsPlaying(true);
        executeNextStep();
    };
    ...
    return (
        <main className="flex min-h-screen flex-col items-center bg-slate-950 text-white p-4 font-sans">
            ...
            <div className="w-full max-w-7xl flex items-center justify-between mb-6">
                ...
                <h1 className="text-3xl font-bold">Jump Search</h1>
            ...
            <div className="w-full max-w-7xl mt-12 bg-slate-900 border border-slate-800 rounded-xl overflow-hidden">
                ...
                <div className="p-4 font-mono text-sm overflow-x-auto">
                    {jumpSearchSnippets.javascript.split('\n').map((line: string, i: number) => (
