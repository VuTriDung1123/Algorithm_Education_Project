...
import { interpolationSearchLogic } from "@/lib/search/interpolationSearchLogic";
import { interpolationSearchSnippets } from "@/lib/search/interpolationSearchCode";
...
export default function InterpolationSearchPage() {
    ...
    const startSearch = () => {
        if (isPlaying) return;
        generatorRef.current = interpolationSearchLogic(array, target);
        setIsPlaying(true);
        executeNextStep();
    };
    ...
    return (
        <main className="flex min-h-screen flex-col items-center bg-slate-950 text-white p-4 font-sans">
            ...
            <div className="w-full max-w-7xl flex items-center justify-between mb-6">
                ...
                <h1 className="text-3xl font-bold">Interpolation Search</h1>
            ...
            <div className="w-full max-w-7xl mt-12 bg-slate-900 border border-slate-800 rounded-xl overflow-hidden">
                ...
                <div className="p-4 font-mono text-sm overflow-x-auto">
                    {interpolationSearchSnippets.javascript.split('\n').map((line: string, i: number) => (
