...
export const algorithmCategories: AlgorithmCategory[] = [
  // I. CẤU TRÚC DỮ LIỆU
  {
    ...
    items: [
      ...
      { title: "Queue", description: "Hàng đợi (FIFO).", href: "/data-structures/queue", tags: ["Basic"], isReady: false },
      { title: "Deque", description: "Hàng đợi hai đầu.", href: "/data-structures/deque", tags: ["Basic"], isReady: false },
      // 2. Cây
      { title: "Binary Tree", description: "Cây nhị phân cơ bản.", href: "/data-structures/binary-tree", tags: ["Tree"], isReady: false },
      { title: "Binary Search Tree (BST)", description: "Cây tìm kiếm nhị phân.", href: "/data-structures/bst", tags: ["Tree"], isReady: false },
      { title: "AVL Tree", description: "BST tự cân bằng.", href: "/data-structures/avl", tags: ["Tree"], isReady: false },
      { title: "Red-Black Tree", description: "BST cân bằng (dùng nhiều trong thư viện).", href: "/data-structures/rbt", tags: ["Tree"], isReady: false },
      { title: "Splay Tree", description: "Cây tự điều chỉnh (mới truy cập đưa lên gốc).", href: "/data-structures/splay", tags: ["Tree"], isReady: false },
      { title: "Treap", description: "Kết hợp Tree và Heap.", href: "/data-structures/treap", tags: ["Tree"], isReady: false },
      { title: "B-Tree", description: "Cây đa phân (dùng cho Disk Storage).", href: "/data-structures/b-tree", tags: ["Tree", "Database"], isReady: false },
      { title: "B+ Tree", description: "Biến thể B-Tree tối ưu truy vấn khoảng.", href: "/data-structures/b-plus-tree", tags: ["Tree", "Database"], isReady: false },
      { title: "Segment Tree", description: "Truy vấn đoạn (RMQ, Sum).", href: "/data-structures/segment-tree", tags: ["Tree", "Advanced"], isReady: false },
      { title: "Fenwick Tree (BIT)", description: "Cây chỉ số nhị phân.", href: "/data-structures/fenwick", tags: ["Tree", "Advanced"], isReady: false },
      { title: "Trie (Prefix Tree)", description: "Cây tiền tố xử lý chuỗi.", href: "/data-structures/trie", tags: ["Tree", "String"], isReady: false },
      // 3. Hash / Set
      { title: "Hash Table", description: "Bảng băm (Key-Value).", href: "/data-structures/hash-table", tags: ["Hash"], isReady: false },
      { title: "Hash Set", description: "Tập hợp các phần tử duy nhất.", href: "/data-structures/hash-set", tags: ["Hash"], isReady: false },
      { title: "Hash Map", description: "Ánh xạ khóa - giá trị.", href: "/data-structures/hash-map", tags: ["Hash"], isReady: false },
      { title: "Bloom Filter", description: "Kiểm tra tồn tại xác suất (tiết kiệm nhớ).", href: "/data-structures/bloom-filter", tags: ["Hash", "Probabilistic"], isReady: false },
      // 4. Heap
      { title: "Min Heap", description: "Phần tử nhỏ nhất ở gốc.", href: "/data-structures/min-heap", tags: ["Heap"], isReady: false },
      { title: "Max Heap", description: "Phần tử lớn nhất ở gốc.", href: "/data-structures/max-heap", tags: ["Heap"], isReady: false },
      { title: "Priority Queue", description: "Hàng đợi ưu tiên.", href: "/data-structures/priority-queue", tags: ["Heap"], isReady: false },
    ]
  },
