...
const algos = [
  ...
  { id: 'floyd', name: 'Floyd-Warshall' },
  { id: 'a-star', name: 'A* Search' },
  { id: 'prim', name: 'Prim Algorithm' },
  { id: 'topo', name: 'Topological Sort' },
  { id: 'tarjan', name: 'Tarjan (SCC)' },
  { id: 'kosaraju', name: 'Kosaraju (SCC)' },
  { id: 'edmonds-karp', name: 'Edmonds-Karp (Max Flow)' },
  { id: 'dinic', name: 'Dinic (Max Flow)' }
];

algos.forEach(algo => {
  const dir = 'src/app/graph/' + algo.id;
